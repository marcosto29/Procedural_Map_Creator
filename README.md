...
The main change this algorithm has from the lee and schatcher is how to take and check the vertices. angles are the most important, to take the first vertex at a given time, the algorithm looks for the smallest angle generated by two vectors given a certain direction.

These vectors always start from the same parent point, the center, and its endings will vary as it is iterated in Hull.
