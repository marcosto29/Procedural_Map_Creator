...
public static class PerlinFunction
{
    ...
    //void Draw(Vector2 Limits, LineRenderer Line, int points, float jump, float speed, float amplitude, float frequency)//1D
    //{
    ...
    public static void DDraw(MeshFilter plane, Vector2 def, Vector3[] vertices, float speed, float amplitude, float frequency, float jump)//2 and 3D
    {
        vertices = plane.mesh.vertices;
